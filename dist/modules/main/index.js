        ...
        constructor(parent, options) {
            ...
            this.onSetupPage = async (connected, hideLoading) => {
                ...
                if (this.targetChainId && chainId != this.targetChainId) {
                    ...
                    await store_2.switchNetwork(this.targetChainId);
                }
            ...
            this.renderSwitchNetworkUI = async () => {
                ...
                const networkInfo = store_2.getNetworkInfo(this.targetChainId);
                this.switchNetworkSection.appendChild(this.$render("i-panel", { class: "no-campaign", height: "100%", background: { color: '#0c1234' } },
                    this.$render("i-vstack", { gap: 10, verticalAlignment: "center", horizontalAlignment: "center" },
                        ...
                        this.$render("i-hstack", { verticalAlignment: 'center', gap: 4, wrap: "wrap" },
                            ...
                            this.$render("i-label", { caption: networkInfo.name, font: { color: '#8dc63f' }, class: 'pointer', onClick: () => store_2.switchNetwork(this.targetChainId) })))));
